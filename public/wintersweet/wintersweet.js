...
timeline.add(mainSetUp).add(branchMaster);
...
function mainSetUp() {
  ...
  .set(branchesRandomOrderLeft, {transformOrigin: 'left bottom'})
  .set(branchesRandomOrderRight, {transformOrigin: 'right bottom'})
  .set(branchesRandomOrderBottom, {transformOrigin: 'center bottom'})
  .set('#BranchGroup-left-1', {transformOrigin: 'left top'})
  .set('#BranchGroup-right-16', {transformOrigin: 'right top'})
